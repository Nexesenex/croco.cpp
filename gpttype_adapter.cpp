...
static void speculative_decoding_setup(std::string spec_model_filename, const llama_model_params & base_model_params, const llama_context_params & base_ctx_params, int base_n_vocab, const float * draft_gpusplit, int draft_gpulayers, int draft_quant_k, int draft_quant_v)
{
    ...
    else 
    {
		...
		(draft_quant_k==28?GGML_TYPE_IQ4_NL:
		(draft_quant_k==27?GGML_TYPE_IQ4_NL:
		(draft_quant_k==26?GGML_TYPE_Q5_0:
		(draft_quant_k==25?GGML_TYPE_Q5_0:
		(draft_quant_k==24?GGML_TYPE_Q5_0:
		(draft_quant_k==23?GGML_TYPE_Q5_1:
		(draft_quant_k==22?GGML_TYPE_Q5_1:
		(draft_quant_k==21?GGML_TYPE_Q5_1:
		(draft_quant_k==20?GGML_TYPE_Q6_0:
		(draft_quant_k==19?GGML_TYPE_Q6_0:
		(draft_quant_k==18?GGML_TYPE_Q6_0:
		(draft_quant_k==17?GGML_TYPE_Q6_0:
		(draft_quant_k==16?GGML_TYPE_Q6_0:
		(draft_quant_k==15?GGML_TYPE_Q8_0:
		(draft_quant_k==14?GGML_TYPE_Q8_0:
		(draft_quant_k==13?GGML_TYPE_Q8_0:
		(draft_quant_k==12?GGML_TYPE_Q8_0:
		(draft_quant_k==11?GGML_TYPE_Q8_0:
		(draft_quant_k==10?GGML_TYPE_F16:
		(draft_quant_k==9?GGML_TYPE_F16:
		(draft_quant_k==8?GGML_TYPE_F16:
		(draft_quant_k==7?GGML_TYPE_F16:
		...
		(draft_quant_v==28?GGML_TYPE_IQ4_NL:
		(draft_quant_v==27?GGML_TYPE_Q4_0:
		(draft_quant_v==26?GGML_TYPE_IQ4_NL:
		(draft_quant_v==25?GGML_TYPE_Q4_0:
		(draft_quant_v==24?GGML_TYPE_Q5_0:
		(draft_quant_v==23?GGML_TYPE_IQ4_NL:
		(draft_quant_v==22?GGML_TYPE_Q4_0:
		(draft_quant_v==21?GGML_TYPE_Q5_0:
		(draft_quant_v==20?GGML_TYPE_IQ4_NL:
		(draft_quant_v==19?GGML_TYPE_Q4_0:
		(draft_quant_v==18?GGML_TYPE_Q5_0:
		(draft_quant_v==17?GGML_TYPE_Q5_1:
		(draft_quant_v==16?GGML_TYPE_Q6_0:
		(draft_quant_v==15?GGML_TYPE_IQ4_NL:
		(draft_quant_v==14?GGML_TYPE_Q4_0:
		(draft_quant_v==13?GGML_TYPE_Q5_0:
		(draft_quant_v==12?GGML_TYPE_Q5_1:
		(draft_quant_v==11?GGML_TYPE_Q6_0:
		(draft_quant_v==10?GGML_TYPE_IQ4_NL:
		(draft_quant_v==9?GGML_TYPE_Q4_0:
		(draft_quant_v==8?GGML_TYPE_Q5_0:
		(draft_quant_v==7?GGML_TYPE_Q5_1:
...
ModelLoadResult gpttype_load_model(const load_model_inputs inputs, FileFormat in_file_format, FileFormatExtraMeta in_file_format_meta)
{
    ...
    else if(file_format==FileFormat::GGUF_GENERIC)
    {
		...
		(inputs.quant_k==15?GGML_TYPE_Q8_0:
		(inputs.quant_k==14?GGML_TYPE_Q8_0:
		(inputs.quant_k==13?GGML_TYPE_Q8_0:
		(inputs.quant_k==12?GGML_TYPE_Q8_0:
		(inputs.quant_k==11?GGML_TYPE_Q8_0:
		(inputs.quant_k==10?GGML_TYPE_F16:
		(inputs.quant_k==9?GGML_TYPE_F16:
		(inputs.quant_k==8?GGML_TYPE_F16:
